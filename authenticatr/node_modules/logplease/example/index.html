<html>
  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      logger1.warn(`This is a log message`);
      logger1.error(`This is a log message`);

      logger2.debug(`This is a log message`);
      logger2.info(`This is a log message`);
      logger2.warn(`This is a log message`);
      logger2.error(`This is a log message`);

      logger3.debug(`This is a log message`);
      logger3.info(`This is a log message`);
